...
class HttpCacheTest extends TestCase
{
    ...
    {
        $httpCache = new CliHttpCache(new ResourceStorage(new RepositoryLogger(), new NullPurger(), new CacheKey(), new ArrayAdapter()));
        $server = [];
    ...
    public function testisNotModifiedTrue(): CliHttpCache
    {
        ...
        $storage = new ResourceStorage(new RepositoryLogger(), new NullPurger(), new CacheKey(), new ArrayAdapter());
    ...
    {
        $httpCache = new HttpCache(new ResourceStorage(new RepositoryLogger(), new NullPurger(), new CacheKey(), new ArrayAdapter()));
        $httpCache->transfer();
