...
class HttpCacheTest extends TestCase
{
    ...
    {
        $httpCache = new CliHttpCache(new ResourceStorage(new NullEtagDeleter(), new ArrayAdapter()));
        $server = [];
    ...
    public function testisNotModifiedTrue(): CliHttpCache
    {
        ...
        $storage = new ResourceStorage(new NullEtagDeleter(), new ArrayAdapter());
    ...
    {
        $httpCache = new HttpCache(new ResourceStorage(new NullEtagDeleter(), new ArrayAdapter()));
        $httpCache->transfer();
